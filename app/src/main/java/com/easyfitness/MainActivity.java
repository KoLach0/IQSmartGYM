...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            showFragment(PROFILE, false); // Create fragment, do not add to backstack
        ...
        dataList.add(new DrawerItem(this.getResources().getString(R.string.Profile), R.drawable.ic_person_black_24dp, true));
